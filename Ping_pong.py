...
class Board(pygame.Rect):
    def __init__(self, x , y, widht, height, color, speed, name= "player"):
        ...
        self.FONT = pygame.font.SysFont("Conic Sans MS", 40)
...
def blit_player_score(window, player_left, player_right, setting_win):
    render_score_right = player_right.FONT.render(str(player_right.SCORE), True, (58, 134, 221))
    render_score_left = player_left.FONT.render(str(player_left.SCORE), True, (58, 134, 221))
    render_name_right = player_right.FONT.render(player_right.NAME, True, (58, 134, 221))
    render_name_left = player_left.FONT.render(player_right.NAME, True, (58, 134, 221))
